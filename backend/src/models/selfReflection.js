...
const selfReflectionSchema = new mongoose.Schema({
  ...
  selfReportedEmotion: {
    type: String,
    enum: ['happy','sad','angry','confused','neutral','anxious','confident','frustrated'],
    required: true
  },
  ...
  emotionGap:        { type: String, enum: ['aligned','underestimated','overestimated','mismatched'], default: 'aligned' },
